...
/** 注册搜索本地 Git 项目命令 */
export function createSearch(treeDataProvider: LocalGitProjectsTreeDataProvider) {
  const search = vscode.commands.registerCommand(`${CMD_PREFIX_LOCAL_GIT}.search`, async () => {
